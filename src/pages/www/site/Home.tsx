            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="mt-6"> 
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  <Carousel>
                    <CarouselContent>
                      <CarouselItem><img src="/img/spring.jpg" alt="" /></CarouselItem>
                      <CarouselItem><img src="/img/Bootstrap.jpg" alt="" /></CarouselItem>
                      <CarouselItem><img src="/img/react.png" alt="" /></CarouselItem>
                      <CarouselItem><img src="/img/Angular.png" alt="" /></CarouselItem>
                    </CarouselContent>
                    <CarouselPrevious />
                    <CarouselNext />
                  </Carousel>
